...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    Block makes content go under it, inline puts content next to eachother.
...
Git is valuable to a team of developers because it allows them to work on seperate sections of a project and then merge them together into one product.
